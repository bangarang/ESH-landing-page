      ...
      <div className="content-container">
        ...
        <div className="column-container">
          <div className="left-content-one">
            ...
            <p id="trigger-discover" className="large-info teal left-info-two tk-museo-slab" data-aos="fade-right" data-aos-delay="500">
              Together, we can
              accelerate your school
              district’s digital future.
            </p>
            <div data-aos="fade-right" data-aos-anchor="#trigger-discover" data-aos-delay="500">
              <a className="discover-button" href="https://www.educationsuperhighway.org/districts/">
                DISCOVER HOW
              </a>
            </div> 
          </div>
          <div className="right-content-one">
            <svg data-aos="illustration-two" data-aos-anchor=".discover-button" data-aos-once id="illustration-two" className="illustration-two mobile" x="0px" y="0px" width="324px" height="476px" viewBox="0 0 324 476" >
          ...
          <div className="left-content-two">
            ...
            <a
              ...
              className="link-text"
              href="https://www.educationsuperhighway.org/districts/"
            >
